    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-green-50">
      ...
      <main className="container py-12">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-4xl font-bold mb-3">Payment Institution (EMI)</h1>
          <p className="text-lg text-gray-600 mb-8">
            Coins.xyz Global Trading Participações Ltda. — Electronic Money Institution under BCB Resolutions 517 & 14/2025
          </p>
          <Card className="border-2 border-green-200 bg-green-50/50 mb-8">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Clock className="w-5 h-5 text-green-600" />
                Status: Structuring and Capitalization
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-600">R$ 9.2M</p>
                </div>
              </div>
            </CardContent>
          </Card>
